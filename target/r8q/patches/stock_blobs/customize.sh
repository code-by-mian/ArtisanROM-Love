...
LOG_STEP_IN "- Add Camera app"
ADD_TO_WORK_DIR "a73xqxx" "system" "system/priv-app/PhotoRemasterService/PhotoRemasterService.apk" 0 0 644 "u:object_r:system_file:s0"
